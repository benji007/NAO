    ...
    <body class="col-sm-12 background-body">
        ...
        <blockquote>
            ...
            while ($resultats = mysql_fetch_assoc($envoi_requete)) {
                ...
                echo "<form class='form-horizontal' role='form' method='POST' action='modifEntreprise.php'><input type='text' name='id' hidden value=". $id . " >" . 
                "<div class='table-responsive col-md-3 .col-md-offset-3'><table class='table table-striped'>" .       
                "<tr><td>Raison Sociale : </td><td COLSPAN=2><input type='text' name='raison_social' value=". $resultats['nom'] . "></td></tr>" .
                "<tr><td>Adresse : </td><td COLSPAN=2><textarea name='adresse'>". $resultats['adresse'] ."</textarea></td></tr>" .
                "<tr><td>Téléphone : </td><td COLSPAN=2><input type='text' name='tel' value=". $resultats['telephone'] . "></td></tr>" .
                "<tr><td>Fax : </td><td COLSPAN=2><input type='text' name='fax' value=". $resultats['fax'] . "></td></tr>" .
                "<tr><td>Email : </td><td COLSPAN=2><input type='text' name='mail' value=". $resultats['email']  . "></td></tr>".
                "<tr><td>Observations : </td><td COLSPAN=2><textarea name='observations'>". $resultats['observations'] ."</textarea></td></tr>" .
                "</table>".
